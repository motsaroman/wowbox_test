...
export default function App() {
  ...
  const [selectedTheme, setSelectedTheme] = useState("techno");
  ...
  const [personalizationStartStep, setPersonalizationStartStep] = useState(1);
  ...
  const getRecommendedBox = () => {
    const styleAnswer = quizAnswers[2]; // Исправлено: вопрос про стиль (Что больше всего нравится?) под индексом 2
    const styleMap = {
      practical: "techno",
      emotions: "cozy",
      quality: "party",
  ...
  const handleQuizAnswer = (questionIndex, answerId) => {
    setQuizAnswers((prev) => ({ ...prev, [questionIndex]: answerId }));
    setTimeout(() => {
  ...
  const handleQuizOrder = () => {
    const box = getRecommendedBox();
    setSelectedTheme(box.id);
        ...
        element={
          <>
              ...
              <div className={styles.hero}>
                ...
                <div className={styles.discount}>
                  ...
                  <div className={styles.discountOverTimeButtonWrapper}>
                    <button className={styles.discountOverTimeButton}>
                      Играть
                    </button>
                ...
                <div className={styles.howToWorkWowBoxMap}>
                  ...
                  <div className={styles.howToWorkWowBoxMapBox}>
                    ...
                    <div className={styles.howToWorkWowBoxMapBoxBody}>
                      ...
                      <p>
                        9–12 оригинальных премиум-товаровНаполнение от 4900 ₽ до
                        120 000 ₽
                      </p>
                      <p>
                        Каждый бокс собирается вручную и проходит проверку
                        качества
                      </p>
                    </div>
                  </div>
              ...
              <div className={styles.quality}>
                ...
                <div className={styles.qualityBoxes}>
                  <div className={styles.qualityBox}>
                    ...
                    <p>
                      Мы читаем ваши комментарии, учитываем ограничения и
                      подбираем товары, которые подойдут именно вам
                    </p>
                  ...
                  <div className={`${styles.qualityBox} ${styles.qualityBox2}`}>
                    ...
                    <p>
                      Мы исключаем товары с браком, следим за состоянием
                      упаковки, проверяем комплектацию
                    </p>
                  ...
                  <div className={`${styles.qualityBox} ${styles.qualityBox3}`}>
                    ...
                    <p>
                      В течении 24 часов мы вышлем вам трек-номер - вы сможете
                      следить где ваш бокс
                    </p>

                    <p>
                      Собрали → Упаковали → Передали курьеру → В пути →
                      Доставлено
                    </p>
                  </div>
                  ...
                  <div className={`${styles.qualityBox} ${styles.qualityBox4}`}>
                    ...
                    <p>
                      Мы упаковываем каждый бокс вручную - красиво, чисто,
                      аккуратно. Еще до открытия вы прочувствуете "Тот самый
                      момент"
                    </p>
                  ...
                  <div className={`${styles.qualityBox} ${styles.qualityBox5}`}>
                    ...
                    <p>
                      Если что-то пойдёт не так - мы решаем быстро,
                      по-человечески, без споров. Без формальных отписок. Мы на
                      вашей стороне
                    </p>
            ...
            onOrderClick={(personalizationData) => {
              ...
              if (personalizationData?.theme) setSelectedTheme(personalizationData.theme);
          ...
          <OrderModal
            ...
            // Передаем тему в модалку заказа
